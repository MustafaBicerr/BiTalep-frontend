...
const SECTIONS: Array<{
  ...
  key: 'info' | 'summary' | 'membership'
  icon: typeof Building2
}> = [
  { to: '/company', end: true, key: 'info', icon: Building2 },
  { to: '/company/summary', key: 'summary', icon: BarChart3 },
  { to: '/company/membership', key: 'membership', icon: CreditCard },
]
